...
export default function Chat() {
  ...
  return (
    <div className="floating-shapes max-h-screen p-10 relative overflow-hidden">
      <div className="">
        <Card className="max-w-2xl mx-auto shadow-2xl border-none bg-white/80 backdrop-blur-lg animate-float overflow-x-hidden rounded-lg">
          <CardHeader className="border-b bg-gradient-to-r from-pink-400 via-purple-400 to-indigo-400 text-white rounded-t-lg">
            <CardTitle className="text-center flex items-center justify-center gap-2 py-2">
              <Stars className="w-6 h-6 animate-pulse" />
              <span className="rainbow-text text-xl font-bold sparkle">{greeting}</span>
              <Wand2 className="w-6 h-6 animate-bounce-in" />
            </CardTitle>
          </CardHeader>
